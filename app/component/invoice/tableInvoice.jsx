    ...
    return (
        ...
        <Table >
          ...
          <TableWrapper style={styles.wrapper}>
            <Col data={state.tableTitle} style={styles.title} heightArr={[28,28]} textStyle={styles.textTiltle}/>
...
const styles = StyleSheet.create({
    ...
    row: {  height: 28, paddingLeft: 5, width: "50%", marginLeft: 8,  borderWidth: 0.3,  borderRadius: 5, borderColor: "#bedefa", margin:2   },
